...
interface CardDao {
    ...
    */
    ...
    /*
    Добавить несколько карточек локально (если уже существует, заменить последним добавленным)
    с использованием парсера
    */
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    ...
    */
    ...
    /*
    Выбрать все карточки определенного набора (неудаленные карточки),

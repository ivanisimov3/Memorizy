...
Приложение помогает создавать учебные наборы и карточки, повторять материал по расписанию, проверять ответы, смотреть статистику и синхронизировать данные с удаленным хранилищем.
...
* Режим обучения и режим проверки знаний
* Локальная интеллектуальная проверка ответов
* Статистика учебных сессий
* Уведомления о повторении
* Импорт и экспорт карточек через CSV
* Offline-first хранение данных с отправкой/получением контента с сервера
